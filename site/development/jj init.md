...
Here’s the output for the same basic command in Git—note that I am not trying to get a _similar_ output from Git, just asking what it shows by default (and warning: wall of log output!):
